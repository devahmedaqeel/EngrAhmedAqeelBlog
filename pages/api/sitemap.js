...
export default function handler(req, res) {
  try {
    ...
    const categoryUrls = categories
      .map((cat) => {
        const catSlug = String(cat).replace(/ /g, "-");
        const cUrl = `${siteUrl}/categories/${catSlug}`;
        return `  <url>
    <loc>${cUrl}</loc>
    <lastmod>${currentDate}</lastmod>
    <changefreq>weekly</changefreq>
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://engr-ahmed-aqeel-blog.vercel.app/</loc>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://engr-ahmed-aqeel-blog.vercel.app/about</loc>
    <priority>0.8</priority>
  </url>
  <url>
    <loc>https://engr-ahmed-aqeel-blog.vercel.app/contact</loc>
    <priority>0.8</priority>
  </url>
  <url>
    <loc>https://engr-ahmed-aqeel-blog.vercel.app/posts</loc>
    <priority>0.8</priority>
  </url>
</urlset>`;
    res.setHeader("Content-Type", "text/xml; charset=utf-8");
